...
CREATE TABLE `basic_funds`  (
  `fund_id` int NOT NULL AUTO_INCREMENT COMMENT '款项id',
...
CREATE TABLE `bookkeeping`  (
  ...
  `bookkeeping_end_date` datetime NULL DEFAULT NULL COMMENT '结束日期',
...
CREATE TABLE `customed_funds`  (
  `customed_fund_id` int NOT NULL AUTO_INCREMENT COMMENT '自定义款项id',
  `uid` int NOT NULL,
...
CREATE TABLE `income`  (
  ...
  `fund_id` int NULL DEFAULT NULL COMMENT '款项id 若是自定义款项则此项空',
  `customed_fund_id` int NULL DEFAULT NULL COMMENT '自定义款项类型id  若是系统自带款项则此项空',
  `comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '备注',
